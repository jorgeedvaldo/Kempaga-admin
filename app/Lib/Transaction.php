...
if (!function_exists('payment_transaction')) {
    function payment_transaction(object $user, object $merchant_user, object $user_emoney, object $merchant_emoney, float $amount, object $admin_user, object $admin_emoney): ?string
    {
        try {
            DB::beginTransaction();
