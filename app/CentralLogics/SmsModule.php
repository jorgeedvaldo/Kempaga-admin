...
class SmsModule
{
    ...
    // Usa o campo 'messaging_service_sid' existente na DB.
    // Se o valor começar com 'VA' usa Verify API; senão usa Messages API legado.
    // -------------------------------------------------------------------------
    ...
    public static function usingTwilioVerify(): bool
    {
        ...
        return isset($config)
            ...
            && strncmp($config['messaging_service_sid'] ?? '', 'VA', 2) === 0;
    }
