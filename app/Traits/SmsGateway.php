...
trait  SmsGateway
{
    ...
    public static function hubtel(string $receiver, string $otp): string
    {
        $config = self::get_settings('hubtel');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function paradox(string $receiver, string $otp): string
    {
        $config = self::get_settings('paradox');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function signal_wire(string $receiver, string $otp): string
    {
        $config = self::get_settings('signal_wire');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function sms_019(string $receiver, string $otp): string
    {
        $config = self::get_settings('019_sms');
    ...
    public static function viatech(string $receiver, string $otp): string
    {
        $config = self::get_settings('viatech');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function global_sms(string $receiver, string $otp): string
    {
        $config = self::get_settings('global_sms');
        $response = 'error';
    ...
    public static function akandit_sms(string $receiver, string $otp): string
    {
        $config = self::get_settings('akandit_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function sms_to(string $receiver, string $otp): string
    {
        $config = self::get_settings('sms_to');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function alphanet_sms(string $receiver, string $otp): string
    {
        $config = self::get_settings('alphanet_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
