...
trait  Processor
{
    public function response_formatter(array $constant, mixed $content = null,  array $errors = []): array
    {
    ...
    public function error_processor(object $validator): array
    {
        $errors = [];
    ...
    public function translate(string $key): array|null|string
    {
        try {
            App::setLocale('en');
    ...
    public function payment_config(?string $key, ?string $settings_type): object|null
    {
        try {
    ...
    public function file_uploader(string $dir, string $format, ?string $image = null, ?string $old_image = null): string
    {
    ...
    public function payment_response(object $payment_info, string $payment_flag): RedirectResponse|Redirector
    {
