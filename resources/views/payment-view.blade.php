...
<head>
    ...
    <link rel="stylesheet" href="{{dynamicAsset(path: 'public/assets/admin/css/payment.css')}}">
    ...
    <link rel="stylesheet" href="{{dynamicAsset(path: 'public/assets/admin/css/bootstrap.css')}}">
        ...
        <div class="col-md-12">
            <div id="loading">
                <div class="loader-css">
                    <img width="200" src="{{dynamicAsset(path: 'public/assets/admin/img/loader.gif')}}"
                                ...
                                <div class="card-body h-70">
                                    <form action="{{ url('/pay-ssl') }}" method="POST" class="needs-validation"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit" id="sslcomz-button">
                                            <img width="100"
                                                 src="{{dynamicAsset(path: 'public/assets/admin/img/sslcomz.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body h-70">
                                    @php($config=\App\CentralLogics\Helpers::get_business_settings('razor_pay'))
                                        ...
                                        $logo = dynamicStorage(path: 'storage/app/public/business') . '/' . \App\CentralLogics\Helpers::get_business_settings('logo');
                                    ...
                                    <form
                                        ...
                                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-name="{{ $name }}"
                                                data-image="{{ dynamicStorage(path: 'storage/app/public/restaurant/'. $logo) }}"
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="razorpay-button"
                                        ...
                                        <img width="100"
                                             src="{{dynamicAsset(path: 'public/assets/admin/img/razorpay.png')}}"
                                ...
                                <div class="card-body h-70">
                                    <form class="needs-validation" method="POST" id="payment-form"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit" id="paypal-button">
                                            <img width="100"
                                                 src="{{dynamicAsset(path: 'public/assets/admin/img/paypal.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body h-70">
                                    ...
                                    <button class="btn btn-block" type="button"
                                        ...
                                        <img width="100"
                                             src="{{dynamicAsset(path: 'public/assets/admin/img/paystack.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-70">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="senangpay-button"
                                        ...
                                        <img width="100"
                                             src="{{dynamicAsset(path: 'public/assets/admin/img/senangpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h-70">
                                    <button class="btn btn-block click-if-alone" id="bKash_button"
                                        ...
                                        <img width="100" src="{{dynamicAsset(path: 'public/assets/admin/img/bkash.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body h-70">
                                    <form class="needs-validation click-if-alone" method="POST" id="payment-form-paymob"
                                        ...
                                        <button class="btn btn-block" type="submit" id="paymob-button">
                                            <img width="150" src="{{dynamicAsset(path: 'public/assets/admin/img/paymob.png')}}"
                            ...
                            <div class="card">
                                <div class="card-body pt-2 h-70">
                                    <button class="btn btn-block click-if-alone" id="mercadopago-button"
                                        ...
                                        <img width="150"
                                             src="{{dynamicAsset(path: 'public/assets/admin/img/MercadoPago_(Horizontal).svg')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body pt-2 h-70">
                                    <form method="POST" action="{{ route('flutterwave_pay') }}">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit"
                                            ...
                                            <img width="200"
                                                 src="{{dynamicAsset(path: 'public/assets/admin/img/fluterwave.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
...
<script src="{{dynamicAsset(path: 'public/assets/admin/js/sweet_alert.j')}}s"></script>
<script src="{{dynamicAsset(path: 'public/assets/admin/js/toastr.js')}}"></script>
<script src="{{dynamicAsset(path: 'public/assets/admin/js/bootstrap.min.js')}}"></script>
