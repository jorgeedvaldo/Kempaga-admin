...
<section style="background-image: url('{{dynamicAsset(path: 'public/assets/installation')}}/assets/img/page-bg.png')"
    ...
    <div class="logo">
        <img src="{{dynamicAsset(path: 'public/assets/installation')}}/assets/img/favicon.svg" alt="{{translate('image')}}">
    </div>
        ...
        <footer class="footer py-3 mt-4">
            <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 align-items-center">
                <div class="footer-logo">
                    <img src="{{dynamicAsset(path: 'public/assets/installation')}}/assets/img/logo.svg" alt="{{translate('image')}}">
                </div>
