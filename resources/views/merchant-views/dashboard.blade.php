        ...
        <div class="card card-body mb-3">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2 pb-1">
                <h5 class="card-title d-flex align-items-center gap-2">
                    <img src="{{dynamicAsset(path: 'public/assets/admin/img/media/business-analytics.png')}}" alt="{{translate('emoney')}}">
...
@push('script')
    ...
    <script
        src="{{dynamicAsset(path: 'public/assets/admin/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js')}}"></script>
@endpush
