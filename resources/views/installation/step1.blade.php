...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="6cash Software Installation"
             ...
             data-bs-placement="top" data-bs-custom-class="custom-progress-tooltip" data-bs-title="{{ translate('First Step') }}!"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.6amtech.com/docs-six-cash/intro" class="d-flex align-items-center gap-1"
                   target="_blank">
                    ...
                    <div class="row g-4 g-md-5">
                        <div class="col-md-4">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/php-version.svg')}}"
                                    alt="{{ translate('image') }}">
                                <div
                                    ...
                                    @if ($phpVersionMatched)
                                        <img width="20" src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/check.png')}}"
                                             alt="{{ translate('image') }}">
                                    @else
                        ...
                        <div class="col-md-4">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/curl-enabled.svg')}}"
                                    alt="{{ translate('image') }}">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex gap-3 align-items-center">
                                <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/route-service.svg')}}"
                                    alt="{{ translate('image') }}">
                                <div
                                    class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
