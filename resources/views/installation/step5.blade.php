...
@section('content')
    ...
    <div class="card mt-4 position-relative">
        <div class="d-flex justify-content-end mb-2 position-absolute top-end">
            <a href="#" class="d-flex align-items-center gap-1">
                        <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                            ...
                            <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/info.svg')}}" alt="{{ translate('image') }}"
                                 class="svg">
                        </span>
            </a>
        </div>
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('These information will be used to create') }} <strong>{{ translate('admin credential') }}</strong>{{ translate('for your admin panel') }}.</p>
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    <label for="business_name" class="d-flex align-items-center gap-2 mb-2">{{ translate('Business Name') }}</label>
                                    <input type="text" id="business_name" class="form-control" name="business_name"
                                           required placeholder="Ex: 6cash">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <label for="phone" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-title="Provide an valid number. This number will be use to send verification code and other attachments in future">
                                                    <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/info2.svg')}}"
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="password" class="d-flex align-items-center gap-2 mb-2">{{ translate('Password') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="confirm_password" class="d-flex align-items-center gap-2 mb-2">{{ translate('Confirm Password') }}</label>
                                    <div class="input-inner-end-ele position-relative">
                                        <input type="password" autocomplete="new-password" id="confirm_password" name="confirm_password"
                                               class="form-control" placeholder="Ex: 8+ character" required>
                                        <div class="togglePassword">
                                            <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/eye.svg')}}"
                                                alt="{{ translate('image') }}" class="svg eye">
                                            <img src="{{dynamicAsset(path: 'public/assets/installation/assets/img/svg-icons/eye-off.svg')}}"
                                                alt="{{ translate('image') }}" class="svg eye-off">
                                        </div>
                                    </div>
                                </div>
