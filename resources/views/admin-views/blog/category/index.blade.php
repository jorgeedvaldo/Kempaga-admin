...
<div class="navbar-collapse offcanvas-collapse offcanvas-collapse-index">
    ...
    <div class="p-3">
        <div class="p-4 bg-fafafa rounded">
            <form id="categoryForm" action="{{ route('admin.blog.category.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="mt-5">
            ...
            <div class="table-responsive table-body__scrolable border rounded overflow-hidden">
                <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    ...
                    <tbody>
                        @include('admin-views.blog.category.partials.table-rows')
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <form action="#" method="post" enctype="multipart/form-data" id="updateCategoryForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer gap-2 mt-4 border-0 pt-1 px-xxl-5 px-4 pb-xxl-5 pb-4">
                    <button type="reset" class="btn btn-secondary min-w-120" >{{translate('reset')}}</button>
                    <button type="submit" class="btn btn-primary category-form-submit min-w-120">{{translate('Update')}}</button>
                </div>
            </div>
        </form>
    </div>
