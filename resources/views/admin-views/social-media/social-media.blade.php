                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize">
                        <div class="card-header-icon d-inline-flex mr-2 img">
                            <img src="{{dynamicAsset(path: 'public/assets/admin/img/social.png')}}" alt="{{ translate('social') }}">
                        </div>
...
@push('script_2')
    ...
    function toogleStatusModal(e, toggle_id, on_image, off_image, on_title, off_title, on_message, off_message) {
        ...
        if ($('#'+toggle_id).is(':checked')) {
            ...
            $('#toggle-status-image').attr('src', "{{dynamicAsset(path: 'public/assets/admin/img/modal')}}/"+on_image);
            ...
            $('#toggle-status-image').attr('src', "{{dynamicAsset(path: 'public/assets/admin/img/modal')}}/"+off_image);
            $('#toggle-status-ok-button').attr('toggle-ok-button', toggle_id);
        }
