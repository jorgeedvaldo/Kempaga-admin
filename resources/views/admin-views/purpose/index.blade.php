...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/target.png')}}" alt="{{ translate('purpose') }}">
                        ...
                        <div class="form-group">
                            <div class="text-center mt-3">
                                <img class="border rounded-10 mx-w300 w-100" id="viewer"
                                        src="{{ dynamicAsset(path: 'public/assets/admin/img/900x400/img1.jpg') }}" alt="{{ translate('image') }}"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table
                    ...
                    @foreach($purposes as $key=>$purpose)
                        <tr>
                            ...
                            <td>
                                <div style="
                                background-color: {{ $purpose['color'] ?? '#000' }};
                                        height: 16px;
                                        width: 64px;
                                        border-radius: 8px;
                                "></div>
