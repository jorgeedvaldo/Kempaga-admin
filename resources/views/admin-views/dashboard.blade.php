...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card card-body mb-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2 pb-1">
                <h5 class="card-title d-flex align-items-center gap-2">
                    <img src="{{dynamicAsset(path: 'public/assets/admin/img/media/business-analytics.png')}}" alt="{{ translate('business_analytics') }}">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                            <h5 class="card-title d-flex align-items-center gap-2">
                                <img src="{{dynamicAsset(path: 'public/assets/admin/img/media/business-analytics.png')}}" class="card-icon" alt="">
        ...
        @push('script')
            <script src="{{dynamicAsset(path: 'public/assets/admin/vendor/chart.js/dist/Chart.min.js')}}"></script>
            <script src="{{dynamicAsset(path: 'public/assets/admin/vendor/chart.js.extensions/chartjs-extensions.js')}}"></script>
            <script src="{{dynamicAsset(path: 'public/assets/admin/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js')}}"></script>
        @endpush
        ...
        @push('script_2')
            <script>
                ...
                const maxDataValue = Math.max(...transactionData);
                const yMax = Math.max(100, Math.ceil(maxDataValue / 100) * 100);
                let stepSize;

                if (yMax < 100) {
                    stepSize = (yMax / 10) * 10;
                } else if (yMax < 1000) {
                    stepSize = (yMax / 100) * 10;
                } else if (yMax < 10000) {
                    stepSize = (yMax / 1000) * 100;
                } else if (yMax < 100000) {
                    stepSize = (yMax / 10000) * 1000;
                } else {
                    stepSize = Math.pow(10, Math.floor(Math.log10(yMax) - 1));
                }
                ...
                function formatNumber(value) {
                    ...
                    return value.toFixed(2); // for small values, 2 decimals
                }
                            ...
                            yAxes: [{
                                ticks: {
                                    ...
                                    callback: function(value) {
                                        return formatNumber(value); // show k, m, b, t
                                    }
                                }
                            }]
                        }
