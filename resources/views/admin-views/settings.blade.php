    ...
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-4 justify-content-between">
            <div class="d-flex align-items-center gap-3">
                <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/settings.png')}}" alt="{{ translate('settings') }}">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                <label for="first_name" class="col-sm-3 col-form-label input-label">{{ translate('Full name') }} <i
