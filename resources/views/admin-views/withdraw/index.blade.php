...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/cash-withdrawal.png')}}" alt="{{ translate('withdraw') }}">
...
@push('script_2')
    <script>
        ...
        $("#withdrawal_method").on('change', function() {
            ...
            location.href = "{{ route('admin.withdraw.requests') }}" +
