...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/store.png')}}"
            ...
            <form action="{{route('admin.merchant.update', $user->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            <label class="input-label"
                                   for="exampleFormControlInput1">{{translate('Identification Type')}}</label>
                            <select name="identification_type" class="form-control">
                                <option
                                    value="passport" {{ $user->identification_type == 'passport' ? 'selected' : '' }}>{{translate('passport')}}</option>
                                <option
                                    value="driving_license" {{ $user->identification_type == 'driving_license' ? 'selected' : '' }}>{{translate('driving')}} {{translate('license')}}</option>
                                <option
                                    value="nid" {{ $user->identification_type == 'nid' ? 'selected' : '' }}>{{translate('nid')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group">
                            <label class="input-label"
                                   for="exampleFormControlInput1">{{translate('Store Name')}}</label>
...
@push('script_2')
    <script src="{{dynamicAsset(path: 'public/assets/admin/js/spartan-multi-image-picker.js')}}"></script>
    <script>
        "use strict";
        ...
        $(function () {
            $("#coba").spartanMultiImagePicker({
                ...
                placeholderImage: {
                    image: '{{dynamicAsset(path: 'public/assets/admin/img/400x400/img2.jpg')}}',
                    width: '100%'
                },
