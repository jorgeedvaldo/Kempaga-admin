...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/agent.png')}}" alt="{{ translate('agent') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 ">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="password" name="password" id="pinInput" class="js-toggle-password form-control form-control input-field"
                ...
                <div class="form-group pt-4">
                    ...
                    <div class="text-center mt-3">
                        <img class="border rounded-10 w-200" id="viewer"
                                src="{{dynamicAsset(path: 'public/assets/admin/img/400x400/img2.jpg')}}" alt="{{ translate('agent image') }}"/>
                    </div>
                </div>
