                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="text-center mb-20">
                            <img src="{{dynamicAsset(path: 'public/assets/admin/img/sent-mail-box.png')}}" alt="{{ translate('mail-box') }}" class="mb-20">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{route('admin.business-settings.send_mail_index')}}" class="btn btn--primary min-w-120">
                                <img src="{{dynamicAsset(path: 'public/assets/admin/img/paper-plane.png')}}" alt=""> {{translate('Send Test Mail')}}
                            </a>
                        </div>
                    </div>
                </div>
