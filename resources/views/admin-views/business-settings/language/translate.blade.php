...
@push('css_or_js')
    <link href="{{dynamicAsset(path: 'public/assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
@endpush

@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/languages.png')}}" alt="{{ translate('language') }}">
...
@push('script')
    <script src="{{dynamicAsset(path: 'public/assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    <script>
        "use strict";
