...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/contact.png')}}" alt="{{ translate('terms_and_condition') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center">
                            <img width="100%" src="{{dynamicAsset(path: 'public/assets/landing/img/section-view/tnc.png')}}" alt="{{ translate('terms_and_condition') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center mb-4">
                        <img width="58" src="{{dynamicAsset(path: 'public/assets/landing/img/media/notes.png')}}" alt="">
                    </div>
