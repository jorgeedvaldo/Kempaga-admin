...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/info.png')}}" alt="{{ translate('media') }}">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    src={{Helpers::onErrorImage($image['value'], dynamicStorage(path: 'storage/app/public/about-us') . '/' . $image['value'], dynamicAsset(path: 'public/assets/admin/img/900x400/img1.jpg'), 'about-us/')}}
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="d-flex justify-content-center">
                                <img width="100%" src="{{dynamicAsset(path: 'public/assets/landing/img/section-view/about.png')}}" alt="{{ translate('about') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-center mb-4">
                            <img width="58" src="{{dynamicAsset(path: 'public/assets/landing/img/media/notes.png')}}" alt="{{ translate('notes') }}">
                        </div>
