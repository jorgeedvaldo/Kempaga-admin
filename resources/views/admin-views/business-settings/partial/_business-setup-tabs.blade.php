<ul class="list-unstyled">
    ...
    <li class="{{Request::is('admin/business-settings/report-disputes')?'active':''}}"><a href="{{route('admin.business-settings.report-disputes')}}">{{translate('Report Disputes')}}</a></li>
