                        ...
                        <tr>
                            ...
                            <td>
                                <img class="height-50px width-50px"
                                     src="{{ Helpers::onErrorImage($item['image'], dynamicStorage(path: 'storage/app/public/landing-page/why-choose-us') . '/' . $item['image'], dynamicAsset(path: 'public/assets/admin/img/900x400/img1.jpg'), 'landing-page/why-choose-us/') }}"
                                     alt="{{ translate('image') }}">
                            </td>
                            <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center">
                    <img width="100%" src="{{ dynamicAsset(path: 'public/assets/landing/img/section-view/choose-us.png') }}"
                         alt="{{ translate('image') }}">
                </div>
            </div>
        </div>
