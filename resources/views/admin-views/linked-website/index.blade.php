...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/media/web.png')}}" alt="{{ translate('linked_website') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-3 text-center">
                            <img class="border rounded-10 w-200" id="viewer"
                                    src="{{dynamicAsset(path: 'public/assets/admin/img/400x400/img2.jpg')}}"
                                    alt="{{ translate('image') }}"/>
                        </div>
                    </div>
