        ...
        <div class="page-header d-flex justify-content-between">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder">
                ...
                <div class="ripple-animation" data-toggle="modal" data-target="#settingModal" type="button">
                    <img src="{{dynamicAsset(path: 'public/assets/admin/img/info.svg')}}" class="svg" alt="{{ translate('info') }}">
                </div>
            </div>
        </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{dynamicAsset(path: 'public/assets/admin/img/addon-setting.png')}}" loading="lazy"
        ...
        <div class="card mb-5">
            <div class="card-body pl-md-10">
                ...
                <form enctype="multipart/form-data" id="theme_form">
                    <div class="row g-3">
                        <div class="col-md-5">
                            <div class="file-upload-parent bg-fafafa rounded p-xl-4 p-3 h-100">
                                <div class="custom-file-upload d-flex align-items-center justify-content-center trigger_input_btn cursor-pointer">
                                    <input type="file" accept=".zip" data-max-file-size="50MB" name="file_upload" id="inputFile" onchange="readUrl(this)" required/>
                                    <div class="text-center">
                                        <div class="mb-1">
                                            <i class="tio-upload-on-cloud text-primary fs-30"></i>
                                        </div>
                                        <p class="mb-0 fs-12">
                                        ...
                                        <div class="theme-clr fs-12 text-underline mt-1 trigger_input_btn">
                                            {{ translate(' Browse file') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="file-preview-list d-flex flex-column gap-4"></div>
                                <div id="file-upload-config" data-icon-src="{{dynamicAsset('public/assets/admin/img/previews-file-img.png')}}"></div>
                                <div class="mt-5 card px-3 py-2 d--none" id="progress-bar">
                                    <div class="d-flex flex-wrap align-items-center gap-3">
                                        <div>
                                            <img width="24" src="{{dynamicAsset(path: 'public/assets/admin/img/zip.png')}}" alt="{{ translate('zip') }}">
                                        </div>
                        ...
                        <div class="col-md-7">
                            <div class="p-lg-4 p-3 theme-bg-10 rounded h-100 d-flex align-items-center">
                                <div>
                            ...
                            <div class="d-flex align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0 me-2 mr-2" data-toggle="modal" data-target="#deleteThemeModal_{{$key}}">
                                        <img src="{{dynamicAsset(path: 'public/assets/admin/img/delete.svg')}}" class="svg" alt="{{ translate('delete') }}">
                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75" src="{{dynamicAsset(path: 'public/assets/admin/img/delete.png')}}" alt="{{ translate('delete') }}">
                                                    </div>
                                ...
                                @endif
                                <button class="{{$data['is_published'] ? 'checkbox-color-primary' : 'text-muted'}} bg-transparent p-0 border-0" data-toggle="modal" data-target="#shiftThemeModal_{{$key}}"><img src="{{dynamicAsset(path: 'public/assets/admin/img/check.svg')}}" class="svg" alt=""></button>
                                <div class="modal fade" id="shiftThemeModal_{{$key}}" tabindex="-1" aria-labelledby="shiftThemeModalLabel_{{$key}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{dynamicAsset(path: 'public/assets/admin/img/shift.png')}}" alt="{{ translate('shift') }}">
                                                </div>
                            ...
                            <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                                ...
                                @else
                                    <img class="img-fit radius-10"
                                         onerror='this.src="{{dynamicAsset(path: 'public/assets/admin/img/placeholder.png')}}"'
                                         src="{{dynamicAsset($addon.'/public/addon.png')}}" alt="{{ translate('addon') }}">
                                @endif
                            </div>
                        </div>
                    </div>
...
@endsection
@push('script_2')
    <script src="{{dynamicAsset(path: 'public/assets/admin')}}/js/main.js"></script>
    <script src="{{dynamicAsset(path: 'public/assets/admin')}}/js/multiple-file-upload.js"></script>
    ...
    <script>
        ...
        function zip_upload() {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#upload_theme').attr('disabled', true);
                },
