...
<div class="modal-body px-4 px-sm-5">
    <div class="mb-4 text-center">
        ...
        <img
            width="200"
            src="{{Helpers::onErrorImage($logo, dynamicStorage(path: 'storage/app/public/business') . '/' . $logo, dynamicAsset(path: 'public/assets/admin/img/1920x400/img2.jpg'), 'business/')}}"
            alt="{{ translate('logo') }}"
            class="dark-support"
        />
    </div>
