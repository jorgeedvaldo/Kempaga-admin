                                ...
                                <div class="col-lg-8">
                                    <div class="how-it-works-img-wrap">
                                        <div class="how-it-works-img bg-contain"
                                            ...
                                            data-bg-img="{{ dynamicAsset(path: 'public/assets/landing/img/media/how-works-img-bg.png') }}">
                                            <img width="524"
                                                src="{{ dynamicStorage(path: 'storage/app/public/landing-page/how-it-works/' . $item['image']) }}"
                                                alt="{{ translate('image') }}">
                                        </div>
                                    </div>
                                </div>
