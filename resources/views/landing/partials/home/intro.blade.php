@if ($data['intro_section']['status'] == '1')
    <div class="banner overflow-hidden" data-bg-img="{{dynamicAsset(path: 'public/assets/landing/img/media/banner-bg.png')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-center justify-content-between gap-3 flex-wrap banner-middle-content">
                    <div class="bg-white p-3 rounded pe-xl-5 star-opacity">
                        <div class="media gap-2 align-items-center">
                            <img width="40"
                                 src="{{dynamicStorage(path: 'storage/app/public/landing-page/intro-section/'.$data['intro_section']['rating_and_user_data']['review_user_icon'])}}"
            ...
            <div class="banner-mobile-frame d-flex gap-2 gap-sm-3 justify-content-center">
                <div class="banner-left-frame">
                    ...
                    <img width="300" src="{{dynamicAsset(path: 'public/assets/landing/img/media/banner-mobile-frame.png')}}"
                         alt="{{translate('image')}}">
                </div>
