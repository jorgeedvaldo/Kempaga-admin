            ...
            <div class="row">
                <div class="col-12">
                    <div class="overlay pt-4 text-white text-center rounded-10 pb-100 px-3"
                         data-bg-img="{{dynamicAsset(path: 'public/assets/landing/img/media/access-6cash-bg.png')}}">
                    ...
                    <div class="position-relative z-1" data-aos="zoom-in" data-aos-duration="500" data-aos-delay="200">
                        <img class="w-100 access-6cash-img"
                             src="{{dynamicStorage(path: 'storage/app/public/landing-page/download-section/'.$data['download_section']['data']['image'])}}"
                             alt="{{translate('image')}}">
                    </div>
                </div>
            </div>
