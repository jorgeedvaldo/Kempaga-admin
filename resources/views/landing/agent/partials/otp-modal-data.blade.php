    ...
    <div class="row align-items-center pb-5">
        <div class="col-12 text-center">
            <div class="d-flex justify-content-center mb-4">
                <img width="172" src="{{dynamicAsset(path: 'public/assets/landing/img/media/otp-verification.png')}}" alt="">
            </div>
...
<div class="modal-body d-flex align-items-center justify-content-center reg-success d-none min-h-500">
    <div class="row align-items-center pb-5">
        <div class="col-12 text-center">
            <div class="d-flex justify-content-center mb-4">
                <img width="172" src="{{dynamicAsset(path: 'public/assets/landing/img/media/otp-success.png')}}" alt="">
            </div>
